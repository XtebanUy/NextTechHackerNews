...
export interface IStoryClient {
    get(title: string | null | undefined, minScore: number | null | undefined, maxScore: number | null | undefined, minTime: Date | null | undefined, maxTime: Date | null | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfStoryDto>;
}
...
export class StoryClient implements IStoryClient {
    ...
    get(title: string | null | undefined, minScore: number | null | undefined, maxScore: number | null | undefined, minTime: Date | null | undefined, maxTime: Date | null | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfStoryDto> {
        let url_ = this.baseUrl + "/api/Story?";
        ...
        if (minTime !== undefined && minTime !== null)
            url_ += "MinTime=" + encodeURIComponent(minTime ? "" + minTime.toISOString() : "") + "&";
        if (maxTime !== undefined && maxTime !== null)
            url_ += "MaxTime=" + encodeURIComponent(maxTime ? "" + maxTime.toISOString() : "") + "&";
        if (pageNumber === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PaginatedListOfStoryDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfStoryDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PaginatedListOfStoryDto> {
